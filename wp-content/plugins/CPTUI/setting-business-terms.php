                ...
                <div id="grid-view-setting">
                    ...
                    <form id="display-settings-grid-form">
                        <div class="form-group">
                            ...
                            <input type="number" name="column" id="column" value="<?php echo $grid_value['column']; ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="rows">Display Rows:</label>
                            <input type="number" name="rows" id="rows" value="<?php echo $grid_value['rows']; ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="grid_shortcode">Shortcode:</label>
                            <input type="text" name="grid_shortcode" id="grid_shortcode" class="cptui-shortcode" readonly value="[business-terms-grid]" title="Copy this shortcode">
                        </div>
                        <div class="form-group">
                            <input type="submit" class="button-primary save-display-setting" id="save-display-grid-setting" value="Save Setting">
                ...
                <div id="list-view-setting">
                    ...
                    <form id="display-settings-List-form">
                        <div class="form-group">
                            ...
                            <input type="number" name="display_terms" id="display_terms_list" value="<?php echo $list_value['display_terms']; ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="list_shortcode">Shortcode:</label>
                            <input type="text" name="list_shortcode" id="list_shortcode" class="cptui-shortcode" readonly value="[business-terms-list]" title="Copy this shortcode">
                        </div>
                        <div class="form-group">
                            <input type="submit" class="button-primary save-display-setting" id="save-display-list-setting" value="Save Setting">
                ...
                <div id="carousel-view-setting">
                    ...
                    <form id="display-settings-Carousel-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="carousel_shortcode" id="carousel_shortcode" class="cptui-shortcode" readonly value="[business-terms-carousel]" title="Copy this shortcode">
                        </div>
                        <div class="form-group">
                            <input type="submit" class="button-primary save-display-setting" id="save-display-carousel-setting" value="Save Setting">
