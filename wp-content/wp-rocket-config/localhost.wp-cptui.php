...
$rocket_cookie_hash = 'cec51d4ca4ed6a757c6a513eb5ca6a53';
$rocket_logged_in_cookie = 'wordpress_logged_in_cec51d4ca4ed6a757c6a513eb5ca6a53';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_ssl = 0;
$rocket_cache_mobile = 0;
$rocket_do_caching_mobile_files = 0;
$rocket_cache_reject_uri = '/wp-cptui(/(?:.+/)?feed(?:/(?:.+/?)?)?$|/(?:.+/)?embed/|/(index.php/)?(.*)wp-json(/.*|$))';
