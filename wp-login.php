...
switch ($action) {
    ...
    default:
        ...
        <div style="background-color: #9CA3AF; ">
            <div class="container mx-auto">
                <div class="login-card">
                    <!-- Row -->
                    <div class="card-partision">
                        <!-- Col -->
                        <div
                                class="grid-img-section"
                                style="
          ...
          "
                        ...
                        <div class="login-form-div">
                            ...
                            <p class="form-control">
                                <label for="user_login"><?php _e('Username or Email Address'); ?></label>
                                <input type="text" name="log" class="input-field"
                                       id="user_login"<?php echo $aria_describedby; ?> class="input"
                                       value="<?php echo esc_attr($user_login); ?>" size="20" autocapitalize="off"
                                       autocomplete="username" required="required"/>
                            </p>

                            <div class="user-pass-wrap form-contro">
                                <label for="user_pass"><?php _e('Password'); ?></label>
                                <div class="wp-pwd">
                                    <input type="password" name="pwd" class="input-field"
                                           id="user_pass"<?php echo $aria_describedby; ?> class="input password-input"
                                    ...
                                    <button type="button" class="button button-secondary wp-hide-pw hide-if-no-js"
                                            data-toggle="0" aria-label="<?php esc_attr_e('Show password'); ?>">
                            ...
                            <p class="submit">
                                <input type="submit" name="wp-submit" id="wp-submit"
                                       class="button button-primary button-large signin-button"
                            ...
                            <p id="nav">
                                ...
                                if (get_option('users_can_register')) {
                                    $registration_url = sprintf('<a class="wp-login-register form-link" href="%s">%s</a>', esc_url(wp_registration_url()), __('Register'));
                                ...
                                $html_link = sprintf('<a class="wp-login-lost-password form-link" href="%s">%s</a>', esc_url(wp_lostpassword_url()), __('Lost your password?'));
    ...
    <style>
        ...
        .container .login-card .card-partision {
            display: flex;
            width: 100%;
        }
        ...
        .login-form .form-control .input-field {
            display: block;
            width: 100%;
